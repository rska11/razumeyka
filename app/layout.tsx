...
export const metadata: Metadata = {
  ...
  description:
    "Онлайн-школа развития детей 4–12 лет: ментальная арифметика, скорочтение, правополушарное рисование и другие направления. Самостоятельные уроки-игры, первые уроки бесплатно.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Ментальная арифметика, скорочтение, рисование и другие направления онлайн. Самостоятельные уроки-игры, первые уроки бесплатно.",
    images: [{ url: "/images/og.png", width: 1200, height: 630, alt: "Разумейка — онлайн-школа развития детей 4–12 лет" }],
  },
