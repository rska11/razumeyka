    ...
    <><Header />
      <main className="mental-page min-h-screen">
        ...
        <section id="podpiska" className="px-5 pb-24 pt-10 sm:px-8 lg:px-14 lg:pb-32"><div className="container-pad px-0"><div className="mental-price-card">
          <div className="mental-price-copy"><span>Доступ к ментальной арифметике</span><h2>Регулярная практика<br />без репетитора и поездок</h2><p>Все уроки ментальной арифметики открываются сразу. Рисование — отдельное направление: его можно открыть по желанию. Ребёнок занимается в удобное время, а прогресс остаётся на устройстве.</p><ul>{mentalSubscription.perks.map((perk)=><li key={perk}><i>✓</i>{perk}</li>)}</ul></div>
